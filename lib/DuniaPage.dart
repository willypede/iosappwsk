...
class DuniaPage extends StatefulWidget {
  ...
  @override
  _DuniaPageState createState() => _DuniaPageState();
}
...
class _DuniaPageState extends State<DuniaPage> {
  ...
  print("before");
  final response = await http.post(Uri.parse("https://www.warungsatekamu.org/wsk_app_2020/load1Dunia.php",
  ), body: {
  });
  ...
  Future<List?> getDunia() async {
  print("before");
  final response = await http.post(Uri.parse("https://warungsatekamu.org/wsk_app_2020/loadDunia.php",
  ), body: {
    "limit": "0"
  });
  print("hasil "+response.body.toString());
  ...
  Future<List> getDunia1() async{
    final responseData = await http.get(Uri.parse('https://warungsatekamu.org/wsk_app_2020/load1Dunia.php'));
