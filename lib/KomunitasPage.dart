...
class _KomunitasPageState extends State<KomunitasPage> {
  ...
  print("before");
  final response = await http.post(Uri.parse("https://www.warungsatekamu.org/wsk_app_2020/load1Komunitas.php",
  ), body: {
  });
  ...
  Future<List?> getKomunitas() async {
  print("before");
  final response = await http.post(Uri.parse("https://warungsatekamu.org/wsk_app_2020/loadKomunitas.php",
  ), body: {
    "limit": "0"
  });
  print("hasil "+response.body.toString());
