...
class _PersonalPageState extends State<PersonalPage> {
  Future<List?> getPersonal() async {
  print("before");
  final response = await http.post(Uri.parse("https://warungsatekamu.org/wsk_app_2020/loadPersonal.php",
  ), body: {
    "limit": "0"
  });
 ...
 void initState() {
  ...
  print("before");
  final response = await http.post(Uri.parse("https://www.warungsatekamu.org/wsk_app_2020/load1Personal.php",
  ), body: {
  });
  //print("hasil "+response.body.toString());
  var data = json.decode(response.body);
